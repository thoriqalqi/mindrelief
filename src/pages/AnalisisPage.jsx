...
import { Brain, Loader2, Send, User, Calendar, Heart, Moon, Target, Smile, MessageCircle } from 'lucide-react';
...
const AnalisisPage = () => {
  ...
  const analyzeWithGemini = async (data) => {
    const prompt = `
    Analisis kondisi mental berdasarkan data berikut:
    - Nama: ${data.namaLengkap}
    - Umur: ${data.umur} tahun
    - Jenis Kelamin: ${data.jenisKelamin}
    - Frekuensi Tidur: ${data.frekuensiTidur}
    - Tingkat Kecemasan: ${data.tingkatKecemasan[0]}/5
    ...
    Berikan analisis dalam format JSON dengan struktur berikut:
    {
      ...
      "rekomendasi": "string dengan rekomendasi lengkap",
      "ringkasan": "string dengan ringkasan kondisi mental"
    }

    Pastikan semua nilai emosi berjumlah 100% dan berikan analisis yang empati dan mendukung.
    `;
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <Label className="text-lg font-semibold text-gray-900 dark:text-white">
                Apakah kamu merasa kesulitan untuk fokus?
              </Label>
              <RadioGroup
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <Label className="text-lg font-semibold text-gray-900 dark:text-white">
                Apakah kamu merasa termotivasi dalam kegiatan sehari-hari?
              </Label>
              <RadioGroup
            ...
            <motion.div variants={itemVariants} className="space-y-2">
              ...
              <Select value={formData.suasanaHati} onValueChange={(value) => handleInputChange('suasanaHati', value)}>
                <SelectTrigger className="text-lg py-3 border-2 border-gray-200 dark:border-gray-600 focus:border-yellow-500 dark:focus:border-yellow-400 rounded-xl">
            ...
            <motion.div variants={itemVariants} className="space-y-2">
              ...
              <Textarea
                id="keresahan"
                placeholder="Ceritakan apa yang membuat Anda merasa resah atau khawatir..."
                value={formData.keresahan}
                onChange={(e) => handleInputChange('keresahan', e.target.value)}
                className="min-h-[120px] text-lg border-2 border-gray-200 dark:border-gray-600 focus:border-green-500 dark:focus:border-green-400 rounded-xl p-4"
                required
              />
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="pt-6">
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white py-4 text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 group"
              >
                {isLoading ? (
                  <>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Analisis menggunakan AI Gemini untuk memberikan insight mendalam
                </p>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-purple-500 rounded-full mt-2"></div>
                <p className="text-gray-700 dark:text-gray-300">
                  Hasil ditampilkan dalam bentuk grafik dan visualisasi interaktif
                </p>
              </div>
            </div>
            <div className="space-y-3">
              ...
              <div className="flex items-start space-x-3">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Rekomendasi personal berdasarkan kondisi mental Anda
                </p>
              </div>
            </div>
          </div>
